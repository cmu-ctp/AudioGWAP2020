/**
 * koa-mongo.js
 * Modified MongoDB driver from https://github.com/nswbmw/koa-mongo.
 */
...
function mongo(connOptions, confOptions = {}) {
  ...
  async function release(resource, clearPool) {
  ...
  return async function koaMongo(ctx, next) {
    ...
    try {
      ...
      await release(ctx.mongo, !!ctx.app.is_cli);
    }
  };
}
